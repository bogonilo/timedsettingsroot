...
public class Thursday_fragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        mAdapter= new TSListAdapter(mContext,dbHelper.getTSs(4));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.listview_thursday, container, false);

        list = (ListView)rootView.findViewById(R.id.thursday_list);
