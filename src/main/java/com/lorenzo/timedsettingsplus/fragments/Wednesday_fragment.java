...
public class Wednesday_fragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        mAdapter= new TSListAdapter(mContext,dbHelper.getTSs(3));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.listview_wednesday, container, false);

        list = (ListView)rootView.findViewById(R.id.wednesday_list);
