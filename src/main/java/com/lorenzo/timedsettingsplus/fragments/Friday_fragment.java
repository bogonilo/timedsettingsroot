...
public class Friday_fragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        mAdapter= new TSListAdapter(mContext,dbHelper.getTSs(5));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.listview_friday, container, false);

        list = (ListView)rootView.findViewById(R.id.friday_list);
