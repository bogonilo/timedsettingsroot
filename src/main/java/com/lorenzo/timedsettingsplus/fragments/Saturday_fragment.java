...
public class Saturday_fragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        mAdapter= new TSListAdapter(mContext,dbHelper.getTSs(6));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mViewGroup = (ViewGroup) inflater.inflate(R.layout.listview_saturday, container, false);

        list = (ListView)mViewGroup.findViewById(R.id.saturday_list);
