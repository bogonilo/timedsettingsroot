...
public class Monday_fragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        mAdapter= new TSListAdapter(mContext,dbHelper.getTSs(1));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.listview_monday, container, false);

        list = (ListView)rootView.findViewById(R.id.monday_list);
